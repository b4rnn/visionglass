...
Filters out Recognised Faces using supplied threshold by matching it with a person of interest from a databases and publish them to various nodes.

# SETUP

*POI has been optimised to run on cpu . No need for GPU.*
# Dependencies
```
...
redis --6379
uwsgi --5017
sudo ufw allow 5017/tcp
sudo ufw allow 5017/udp
```
...
cd to  POI FOLDER 
    ...
    cd build  && rm -rf CMakeCache.txt ENGINE  CMakeFiles POI Makefile  __pycache__  cmake_install.cmake 
    cmake ..
    make -j{NUMBER_OF_THREADS}
#If successful ... you will have the compiled project name i.e POI
    CMakeCache.txt  CMakeFiles  POI app.ini  Makefile  app.py  cmake_install.cmake  libfacedetect.so wsgi.py
#start flask server
    uwsgi --ini app.ini
```
