# ALERTS
Generates POI template based on supplied data and publish them to various nodes.

# SETUP

*ALERTS has been optimised to run on cpu . No need for GPU.*
# Dependencies
```
...
cd to  ALERTS FOLDER 
    ...
    cd build  && rm -rf CMakeCache.txt ENGINE  CMakeFiles ALERTS Makefile  __pycache__  cmake_install.cmake 
    cmake ..
    make -j{NUMBER_OF_THREADS}
#If successful ... you will have the compiled project name i.e ALERTS
    CMakeCache.txt  CMakeFiles  ALERTS app.ini  Makefile  app.py  cmake_install.cmake  libfacedetect.so wsgi.py
#start flask server
    uwsgi --ini app.ini
```
